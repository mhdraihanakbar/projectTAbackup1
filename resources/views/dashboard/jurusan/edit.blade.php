                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="overview-wrap">
                            <h2 class="title-1">Edit Data Jurusan</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-borderless table-data3">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <strong>Edit</strong> Data Jurusan
                                </div>
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="jurusan" class=" form-control-label">Nama Jurusan</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="namajurusan" name="namajurusan"
                                                    ...
                                                    value="{{ old('jurusan', $jurusan->namajurusan) }}">
